  ...
  <body>
    <header>
      ...
      >
        <div class="container-fluid justify-content-end">
          ...
          >
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item d-none d-md-block" id="search">
                <a class="nav-link nav-link__search active" href="#">
          ...
          <div class="user-div hide u-box-shadow-1">
            ...
            <div class="user--menu">
              ...
              <a class="user--menu-item mb-3" href="#">
        ...
        <div class="d-flex nav-right__box">
          <a class="btn btn-blue mx-4" href="#"
            >Credit: <span id="credit">50</span>
          </a>
    ...
    <main id="peopleData">
      <section class="section-user-dashboard">
        ...
        <form action="{{ url('download-csv') }}" method="post" enctype="multipart/form-data">
...
{{-- 
                  ...
                  <td>{{ $item->person_location_state }}, {{ $item->person_location_country }}</td>
